...
import com.vastlb.wing_me.DataClasses.RelationshipClass
import com.vastlb.wing_me.R

class RelationshipsAdapter(val array: ArrayList<RelationshipClass>, val context: Context, val select: (index: Int) -> Unit): RecyclerView.Adapter<RelationshipsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val cell = LayoutInflater.from(p0.context).inflate(R.layout.row_layout_relationship, p0, false)
        return ViewHolder(cell, p1)
    }

    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        val jsonObject: RelationshipClass = array[p1]
