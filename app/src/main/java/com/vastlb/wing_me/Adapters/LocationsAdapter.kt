...
class LocationsAdapter(val array: ArrayList<LocationClass>, val select: (index: Int) -> Unit): RecyclerView.Adapter<LocationsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ViewHolder {
        val cell = LayoutInflater.from(p0.context).inflate(R.layout.row_layout_location, p0, false)
        return ViewHolder(cell, p1)
    }

    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        val jsonObject: LocationClass = array[p1]
